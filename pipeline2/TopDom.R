...
TopDom <- function( matrix.file, window.size, outBinSignal=NULL, outDomain=NULL)
{
  print("#########################################################################")
  print("Step 0 : File Read and Matrix Scaling..")
  print("#########################################################################")
